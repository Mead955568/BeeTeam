...
public class HoneyPointsWelsh : MonoBehaviour //This is a script to calculate how much honey has been collected while playing audio when specific milestones are met.
{
public PointsWelsh playerScoreScript;
...
public IEnumerator Honey()
{
    if (inTheHive == true) // This is a check to see if the bool is true
    {
        ...
        {
            playerScoreScript = GameObject.Find("PlayerModel").GetComponent<PointsWelsh>();
